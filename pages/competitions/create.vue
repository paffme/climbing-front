import { CategoryName } from "~/definitions/definitions";
import { Sex } from "~/definitions/definitions";
<template>
...
<script lang="ts">
  ...
  import { CategoryName, Competition, Sex, TypeCompetition } from "~/definitions/definitions";
