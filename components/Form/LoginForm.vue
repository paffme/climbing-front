<template>
  <form v-on:submit.prevent="emitForm(userCredential.email, userCredential.password)">
    <b-field label="Email" required>
      <b-input v-model="userCredential.email" type="text"></b-input>
    </b-field>
    <b-field label="Mot de passe">
      <b-input v-model="userCredential.password" password-reveal type="password" required></b-input>
    </b-field>
