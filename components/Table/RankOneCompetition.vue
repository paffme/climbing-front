<template>
  <b-table
    ...
    <template slot-scope="props">
      ...
      <b-table-column field="climber.firstName" label="Prénom" sortable searchable>
...
<script lang="ts">
  ...
  export default class RankOneCompetition extends Vue {
    ...
    onSelectCategory(category: CategoryName, oldCategory: CategoryName) {
      this.refreshRankData(this.selectedSex, category)
    }
    @Watch('selectedSex', { immediate: true })
    onSelectSex(sex: Sex, oldSex: Sex) {
